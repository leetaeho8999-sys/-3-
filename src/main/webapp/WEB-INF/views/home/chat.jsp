...
.ac-panel-name em { font-style: italic; color: #C8A97E; }
.ac-panel-tagline {
    font-size: 0.82rem;
...
.ac-panel-deco { display: flex; flex-direction: column; gap: 12px; }
.ac-deco-item {
    display: flex;
    align-items: center;
    gap: 14px;
...
.ac-deco-item:hover { background: rgba(200,169,126,0.14); }
.ac-deco-item .di-icon { font-size: 1.3rem; flex-shrink: 0; width: 28px; text-align: center; }
.ac-deco-item .di-title { font-size: 0.8rem; color: rgba(250,247,242,0.85); font-weight: 500; margin-bottom: 2px; }
.ac-deco-item .di-desc { font-size: 0.68rem; color: rgba(200,169,126,0.6); letter-spacing: 0.3px; }
.ac-panel-bottom {
    font-size: 0.65rem;
...
.ac-welcome .aw-title {
    font-family: 'Playfair Display', serif;
    font-size: 1.5rem; color: #3B2314;
}
.ac-welcome .aw-line { width: 36px; height: 1px; background: #C8A97E; }
.ac-welcome .aw-sub {
    font-size: 0.85rem; color: #8C7B6E;
...
.ac-chip {
    padding: 7px 16px;
    background: #FFFFFF; border: 1px solid #C8A97E;
    color: #7B4F2E; font-size: 0.78rem;
    border-radius: 20px; cursor: pointer;
    transition: all 0.2s;
    font-family: 'Noto Sans KR', sans-serif;
}
.ac-chip:hover { background: #3B2314; color: #FAF7F2; border-color: #3B2314; }
...
.ac-bubble.waiting {
    ...
    border-radius: 4px 16px 16px 16px;
    color: #8C7B6E; font-style: italic; font-size: 0.82rem;
}

/* 입력 */
.ac-input-area {
    padding: 18px 32px 22px;
    background: #FFFFFF; border-top: 1px solid #EDE5DA; flex-shrink: 0;
}
.ac-input-row {
    display: flex; align-items: center; gap: 10px;
    background: #FAF7F2;
    border: 1.5px solid #C8A97E; border-radius: 50px;
...
.ac-input-row input {
    ...
    font-family: 'Noto Sans KR', sans-serif;
    font-size: 0.875rem; color: #3D2B1F; outline: none; padding: 6px 0;
}
...
.ac-btn-reset {
    width: 40px; height: 40px; border-radius: 50%;
    background: transparent; border: 1px solid #D4C4B0; color: #8C7B6E;
...
.ac-input-hint {
    font-size: 0.65rem; color: #C0B0A0;
