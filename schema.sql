...
CREATE TABLE IF NOT EXISTS chat_keyword (
  ...
  COMMENT='AI 챗봇 키워드 기반 힌트 테이블 — GeminiService.askWithHint()에서 참조';
...
CREATE TABLE IF NOT EXISTS chat_history (
  ...
  COMMENT='AI 챗봇 대화 기록 테이블 — ChatMapper.saveHistory() / getAiHistory() 사용';
...
('추천',    '처음 오셨다면 시그니처 라떼(6,000원)를 추천드려요! 파나마 게이샤 원두로 만든 특별한 레시피예요. 진한 맛을 좋아하신다면 아인슈페너도 인기가 많아요.'),
('가격',    '아메리카노 4,000원 / 라떼류 4,500~5,000원 / 스페셜 5,000~6,000원입니다. 개인 텀블러 지참 시 500원 할인됩니다.'),
('매장',    '서울시 강남구 테헤란로 123, 역삼역 3번 출구 도보 5분 거리에 있습니다. 평일 08:00~22:00, 주말 09:00~23:00 영업합니다.'),
('영업',    '평일 08:00~22:00, 주말 09:00~23:00 영업합니다. 월요일은 정기 휴무입니다.'),
('이벤트',  '현재 3월 한 달간 아메리카노 1+1 이벤트 진행 중입니다! SNS 팔로우 시 첫 방문 10% 할인 쿠폰도 제공해드려요.'),
('멤버십',  '멤버십은 베이직(무료), 실버(9,900원/월), 골드(19,900원/월) 3가지 플랜이 있습니다. 실버 이상 가입 시 10~20% 상시 할인과 포인트 적립 혜택을 받으실 수 있어요.'),
('텀블러',  '개인 텀블러를 지참하시면 500원 할인해 드립니다. 환경도 지키고 혜택도 받으세요!'),
('와이파이', '무료 와이파이를 제공합니다. 비밀번호는 매장 내 안내판을 확인해 주세요.'),
('주차',    '매장 인근 공영주차장을 이용하시거나, 지하철(역삼역 3번 출구)을 이용하시면 편리합니다.');
