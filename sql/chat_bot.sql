-- ================================================================
-- 로운 카페 — 챗봇 (chat_bot) DB 설정
-- 대상 DB : project
-- DB 접속 : dbuser1 / 1234
-- 참조 위치: D:\dev\중간프로젝트\Home_Page\cafe-spring
-- ================================================================
...
CREATE TABLE IF NOT EXISTS chat_keyword (
    ...
    bad_count    INT          NOT NULL DEFAULT 0 COMMENT '👎 비추천 횟수'
...
CREATE TABLE IF NOT EXISTS chat_rating (
    ...
    created_at  TIMESTAMP          DEFAULT CURRENT_TIMESTAMP,
    keyword_id  INT                DEFAULT NULL COMMENT '매칭된 키워드 ID (없으면 NULL)',
    CONSTRAINT fk_rating_keyword FOREIGN KEY (keyword_id) REFERENCES chat_keyword (id) ON DELETE SET NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
