    ...
    <div id="noncoffee" class="menu-section">
        ...
        <div class="menu-grid">
            ...
            <div class="menu-card" onclick="openDetail(this)"
                ...
                <p class="item-type">HOT / ICE</p>
                <div class="price-row"><span class="price">5,100원</span></div>
            </div>
            ...
            <div class="menu-card" onclick="openDetail(this)"
                ...
                <p class="item-type">HOT / ICE</p>
                <div class="price-row"><span class="price">5,000원</span></div>
            </div>
    ...
    <div id="tea" class="menu-section">
        ...
        <div class="menu-grid">
            ...
            <div class="menu-card" onclick="openDetail(this)"
                ...
                <p class="item-type">HOT / ICE</p>
                <div class="price-row"><span class="price">4,850원</span></div>
            </div>
    ...
    <div id="frappe" class="menu-section">
        ...
        <div class="menu-grid">
            ...
            <div class="menu-card" onclick="openDetail(this)"
                ...
                <p class="item-type">ICE</p>
                <div class="price-row"><span class="price">5,850원</span></div>
            </div>
        ...
        <div class="sub-category">
            ...
            <div class="menu-grid">
                <div class="menu-card" onclick="openDetail(this)"
                    ...
                    <div class="price-row"><span class="price">6,500원</span></div>
                </div>
                <div class="menu-card" onclick="openDetail(this)"
                ...
                <div class="menu-card" onclick="openDetail(this)"
                    ...
                    <p class="item-type">Cake</p>
                    <div class="price-row"><span class="price">7,000원</span></div>
                </div>
            </div>
        </div>
        ...
        <div class="sub-category">
            ...
            <div class="menu-grid">
                ...
                <div class="menu-card" onclick="openDetail(this)"
                    ...
                    <p class="item-type">Bakery</p>
                    <div class="price-row"><span class="price">3,400원</span></div>
                </div>
                <div class="menu-card" onclick="openDetail(this)"
                ...
                <div class="menu-card" onclick="openDetail(this)"
                    ...
                    <p class="item-type">Bakery</p>
                    <div class="price-row"><span class="price">3,150원</span></div>
                </div>
                <div class="menu-card" onclick="openDetail(this)"
                    ...
                    <p class="item-type">Bakery</p>
                    <div class="price-row"><span class="price">3,050원</span></div>
                </div>
            </div>
        </div>
        ...
        <div class="sub-category">
            ...
            <div class="menu-grid">
                ...
                <div class="menu-card" onclick="openDetail(this)"
                    ...
                    <p class="item-type">Snack</p>
                    <div class="price-row"><span class="price">2,800원</span></div>
                </div>
                <div class="menu-card" onclick="openDetail(this)"
                    ...
                    <p class="item-type">Snack</p>
                    <div class="price-row"><span class="price">2,750원</span></div>
                </div>
                <div class="menu-card" onclick="openDetail(this)"
        ...
        <div class="sub-category">
            ...
            <div class="menu-grid">
                <div class="menu-card" onclick="openDetail(this)"
                    ...
                    <div class="price-row"><span class="price">4,750원</span></div>
                </div>
                <div class="menu-card" onclick="openDetail(this)"
                    ...
                    <p class="item-type">Brunch</p>
                    <div class="price-row"><span class="price">4,900원</span></div>
                </div>
                <div class="menu-card" onclick="openDetail(this)"
                ...
                <div class="menu-card" onclick="openDetail(this)"
                    ...
                    <p class="item-type">Brunch</p>
                    <div class="price-row"><span class="price">3,800원</span></div>
                </div>
                <div class="menu-card" onclick="openDetail(this)"
